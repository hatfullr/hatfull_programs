...
def read(filename,
    ...
    with open(filename,'rb') as f:
        ...
        try:
            ...
            print "  Error: Failed to read '"+filename+"'. Make sure your fmt_dataline is correct. For example, if ncooling =/= 0, you need 2 more 'f8,' symbols. Open read_sph_data.py for more help."
            sys.exit()
